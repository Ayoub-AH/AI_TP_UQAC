...
//------------------------------------------------------------------------
//
//  miner  keeps buying Whiskey until his thirst is quenched. When satisfied 
//  he returns to the goldmine and resumes his quest for nuggets.
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------
//
//  miner changes location to the saloon, and observe vibes in the saloon
//------------------------------------------------------------------------
class GoesToABar : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	GoesToABar(const GoesToABar&);
	GoesToABar& operator=(const GoesToABar&);
...
//------------------------------------------------------------------------
//
//  Bob is now fighting with someone
//------------------------------------------------------------------------
class MinerFighting : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	MinerFighting(const MinerFighting&);
	MinerFighting& operator=(const MinerFighting&);
...
//------------------------------------------------------------------------
//
//  miner will go to the hospital after a huge brawl that he lost
//------------------------------------------------------------------------
class GoToHospital : public State<Miner>
{
private:
